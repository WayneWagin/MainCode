...
def fuction2_display(Loc):
    ...
    endcity_img = cv2.imread("purpur block img.png")
    #endcity_img from https://minecraft.fandom.com/wiki/Purpur_Block 2023/04/05
    endstone_img = cv2.imread("end stone img.png")
    #endstone_img from https://minecraft.fandom.com/wiki/End_Stone 2023/04/05
    player_img = cv2.imread("player img.png")
    #player_img from https://minecraft.fandom.com/wiki/Player 2023/04/05
    right_arrow_img = cv2.imread("right arrow img.png")
    down_arrow_img = cv2.imread("down arrow img.png")
    bottom_right_arrow_img = cv2.imread("bottom right arrow img.png")
    ...
    #display
    cv2.namedWindow("End City Locater", cv2.WINDOW_AUTOSIZE)
    cv2.imshow('End City Locater', img)
