...
def main_menu():
    ...
    stronghold_img = cv2.imread("stronghold.png")
    end_city_img = cv2.imread("end_city.png")
    ...
    text1 = "Stronghold location"
    text2 = "End city location"
    cv2.putText(img, text1, (291, 135), cv2.FONT_HERSHEY_TRIPLEX,
                0.8, (200, 70, 90), 1, cv2.LINE_8)
